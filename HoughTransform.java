...
public class HoughTransform extends Thread { 
    ...
    public static void main(String[] args) { 
        try {
            ...
            BufferedImage oImage = javax.imageio.ImageIO.read(new File(filename)); 
            ...
            ImageIO.write(oImage, "bmp", new File("C:/plop123.bmp"));
